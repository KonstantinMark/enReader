...
import com.bignerdranch.android.testpdfreader.controller.resource.resource_view.page.service.impl.OnParagraphSelectedListenerImpl;
import com.bignerdranch.android.testpdfreader.controller.resource.resource_view.page.service.impl.OnParagraphSelectionChangedListener;
...
public class PageAdapter extends RecyclerView.Adapter<PageAdapter.PageHolder> {
        ...
        if(mItemList == null){
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    PageParagraphWrapper oldItem = mItemList.get(oldItemPosition);
                    PageParagraphWrapper newItem = itemList.get(newItemPosition);
    ...
    public List<? extends PageParagraphWrapper> getItemList() {
        return mItemList;
    }
